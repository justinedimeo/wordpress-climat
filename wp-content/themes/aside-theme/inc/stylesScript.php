...
wp_register_style( 'open_bootstrap', CSS_URL . '/open-iconic-bootstrap.min.css' );
wp_enqueue_style( 'open_bootstrap' );

wp_register_style( 'owl_carousel', CSS_URL . '/owl.carousel.min.css' );
wp_enqueue_style( 'owl_carousel' );

wp_register_style( 'owl_theme', CSS_URL . '/owl.theme.default.min.css' );
...
// SCRIPTS
wp_register_script('jquery-3.2.1', JS_URL . '/jquery-3.2.1.slim.min.js', array('jquery'),'1.0', true);
